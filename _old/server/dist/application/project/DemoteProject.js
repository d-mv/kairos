    ...
    async execute(projectId, userId) {
        ...
        for (const task of projectTasks) {
            ...
            if (subtasks.length > 0) {
                return Result.fail(`Cannot demote project: task "${task.title}" has subtasks. Remove subtasks first.`);
            }
        }
        ...
        for (const t of projectTasks) {
            ...
            if (subtaskResult.isErr)
                return Result.fail(subtaskResult.error);
...
//# sourceMappingURL=DemoteProject.js.map