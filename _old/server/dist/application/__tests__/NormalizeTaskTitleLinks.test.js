...
describe("normalizeTaskTitleLinks", () => {
    ...
    it("does not rewrite urls already inside markdown links", async () => {
        ...
        const result = await normalizeTaskTitleLinks("Keep [Docs](https://kairos-web.fly.dev/inbox) and add https://kairos-app.fly.dev/mcp", fetchLike);
        expect(result).toBe("Keep [Docs](https://kairos-web.fly.dev/inbox) and add [Kairos](https://kairos-app.fly.dev/mcp)");
    });
...
//# sourceMappingURL=NormalizeTaskTitleLinks.test.js.map