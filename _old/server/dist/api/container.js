...
export const createCollaborationInvite = new CreateCollaborationInvite(userDirectory, collaborationInviteRepo, collaborationShareRepo, projectRepo, taskRepo, brainFolderRepo, brainPageRepo, (recipientUserId, notification) => {
