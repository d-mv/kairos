...
export function createKairosMcpServer({ getUserId }) {
        ...
        try {
            ...
            switch (name) {
                ...
                case "update_task":
                    ...
                    break;
                case "delete_task":
                    result = await container.deleteTask.execute(a["id"], userId);
                    break;
                case "complete_task":
                    result = await container.completeTask.execute(a["id"], userId);
                    break;
                case "reopen_task":
                    result = await container.reopenTask.execute(a["id"], userId);
                    break;
                case "promote_task":
                    result = await container.promoteTask.execute(a["id"], userId);
                    break;
                case "list_projects":
                ...
                case "create_project":
                    ...
                    break;
                case "demote_project":
                    result = await container.demoteProject.execute(a["id"], userId);
                    break;
                case "create_link":
...
//# sourceMappingURL=kairosMcpServer.js.map