...
export type WsEvent = {
    ...
    type: "brain-folder:created";
    payload: BrainFolderDTO;
} | {
    type: "brain-folder:updated";
    payload: BrainFolderDTO;
} | {
    type: "brain-folder:deleted";
    payload: {
        id: string;
    };
} | {
    type: "brain-page:created";
    payload: BrainPageDTO;
} | {
    type: "brain-page:updated";
    payload: BrainPageDTO;
} | {
    type: "brain-page:deleted";
    payload: {
        id: string;
    };
} | {
