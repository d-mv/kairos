...
import { getCompletedTasks, getTodayTasks, getUpcomingTasks } from "../lib/task-views.js";
...
export const completedTasksAtom = atom((get) => getCompletedTasks(get(tasksAtom)));
