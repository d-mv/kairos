...
config :kairos, KairosWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "hzRHJxM9KNdcuuW76oDKWBS6bOVggD1ed3MW+i87SW3yO/+voptjDud5OiZwwwQ1",
  watchers: [
...
config :kairos, KairosWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/kairos_web/router\.ex$"E,
      ~r"lib/kairos_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]
