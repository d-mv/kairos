...
#
#     PHX_SERVER=true bin/kairos start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :kairos, KairosWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  ssl_opts =
    if System.get_env("DATABASE_SSL_VERIFY") == "verify_none" do
      [verify: :verify_none]
    else
      true
    end
  ...
  config :kairos, KairosWeb.Endpoint,
    url: [host: host, port: url_port, scheme: scheme, path: url_path],
    http: [
