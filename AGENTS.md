...
Self-hosted Phoenix task management app. Elixir/Phoenix 1.8 + LiveView + Supabase PostgreSQL.

Read `docs/architecture.md` and `docs/plan.md` before starting any task.
Reference implementation is in `_old/` — domain logic and UI reference only, do not port code directly.
